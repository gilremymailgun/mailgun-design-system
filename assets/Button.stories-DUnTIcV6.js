    ...
    padding: '24px'
      ...
      gap: '12px'
        ...
        color: 'var(--sys-color-text-muted)'
          ...
          <Button hierarchy={hierarchy} size="default" iconPosition="leading" icon={<Icon name="arrows/undo-gen1" />}>
            Undo
          </Button>
          <Button hierarchy={hierarchy} size="default" iconPosition="only" icon={<Icon name="arrows/restart-gen1" />} aria-label="Restart" />
        </div>)}
    </div>
