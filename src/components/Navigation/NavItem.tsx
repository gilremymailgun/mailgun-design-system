      ...
      {(hasChevron || isExternal) && (
        <div className="nav-item__chevron">
          {isExternal ? (
            ...
            // keyboard_control_key — section is open
            <span className="material-symbols-rounded nav-chevron-icon" aria-hidden="true">keyboard_control_key</span>
          ) : (
            // keyboard_arrow_down — section is closed
            <span className="material-symbols-rounded nav-chevron-icon" aria-hidden="true">keyboard_arrow_down</span>
          )}
        </div>
      )}
    </div>
